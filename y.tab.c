...
#define OPERATOR 260
#define NUMBER 261
#define EQUALSIGN 262
#define SEMICOLON 263
#define CURVYOPEN 264
#define CURVYCLOSE 265

/* Value type.  */
#if ! defined YYSTYPE && ! defined YYSTYPE_IS_DECLARED
union YYSTYPE
{
#line 44 "termproject.y"
...
{
       0,    56,    56,    59,    60,    63,    73,    83,    93,   103,
     113,   124,   129,   134,   140,   145,   151
};
#endif
...
{
  "$end", "error", "$undefined", "VARIABLE", "COMMA", "OPERATOR",
  "NUMBER", "EQUALSIGN", "SEMICOLON", "CURVYOPEN", "CURVYCLOSE", "'+'",
  "'-'", "$accept", "program", "statements", "statement", "signednumber",
  "variables", "livevariables", YY_NULLPTR
};
#endif
...
{
       3,    -6,    16,    11,    -7,    -3,    -7,    14,    -7,    -7,
      13,    -7,    18,    20,    17,    19,    21,    -1,    -7,    -7,
      -7,     1,    -7,    14,    -7,    22,    24,    25,    26,    -7,
      -7,    -7,    -7,    -7
};
...
{
       0,     0,     0,     0,     4,     0,     1,     0,     3,     2,
       0,    13,     0,     0,     0,    14,     0,     0,    10,    11,
      12,     0,     9,     0,    16,     0,     0,     0,     0,    15,
       8,     7,     6,     5
};
...
{
      10,     5,    25,    11,    27,    11,     1,    11,    12,    13,
      12,    13,    12,    13,     1,    26,     6,    15,    17,    28,
       7,    18,    21,    23,    19,    22,    20,    29,     0,     0,
      30,    24,    31,    32,    33,     8
};

static const yytype_int8 yycheck[] =
{
       3,     7,     3,     6,     3,     6,     3,     6,    11,    12,
      11,    12,    11,    12,     3,    17,     0,     3,     5,    21,
       9,     8,     5,     4,     6,     8,     6,    23,    -1,    -1,
       8,    10,     8,     8,     8,     3
};
...
{
       0,     3,    14,    15,    16,     7,     0,     9,    16,    19,
       3,     6,    11,    12,    17,     3,    18,     5,     8,     6,
       6,     5,     8,     4,    10,     3,    17,     3,    17,    18,
       8,     8,     8,     8
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 5:
#line 64 "termproject.y"
                        {
				Statement new_statement;
				new_statement.destination = string((yyvsp[-5].str));
				new_statement.first_source = Operand{false, "", (yyvsp[-3].number)};
				new_statement.op = string((yyvsp[-2].str));
				new_statement.second_source = Operand{false, "", (yyvsp[-1].number)};
...
#line 1380 "y.tab.c"
  ...
  case 6:
#line 74 "termproject.y"
                        {
				Statement new_statement;
				new_statement.destination = string((yyvsp[-5].str));
				new_statement.first_source = Operand{false, "", (yyvsp[-3].number)};
				new_statement.op = string((yyvsp[-2].str));
				new_statement.second_source = Operand{true, (yyvsp[-1].str), 0};
				all_statements.push_back(new_statement);
			}
#line 1393 "y.tab.c"
    break;
  ...
  case 7:
#line 84 "termproject.y"
                        {
				Statement new_statement;
				new_statement.destination = string((yyvsp[-5].str));
				new_statement.first_source = Operand{true, (yyvsp[-3].str), 0};
				new_statement.op = string((yyvsp[-2].str));
				new_statement.second_source = Operand{false, "", (yyvsp[-1].number)};
				all_statements.push_back(new_statement);
			}
...
#line 1419 "y.tab.c"
  ...
  case 9:
#line 104 "termproject.y"
                        {
				Statement new_statement;
				new_statement.destination = string((yyvsp[-3].str));
				new_statement.first_source = Operand{false, "", (yyvsp[-1].number)};
				new_statement.op = "";
...
#line 1432 "y.tab.c"
  ...
  case 10:
#line 114 "termproject.y"
                        {
				Statement new_statement;
				new_statement.destination = string((yyvsp[-3].str));
				new_statement.first_source = Operand{true, (yyvsp[-1].str), 0};
				new_statement.op = "";
				new_statement.second_source = Operand{false, "", 0};
				all_statements.push_back(new_statement);
			}
...
#line 1453 "y.tab.c"
  ...
  case 12:
#line 130 "termproject.y"
                                {
				(yyval.number) = 0 - (yyvsp[0].number);
				}
#line 1461 "y.tab.c"
    break;

  case 13:
#line 135 "termproject.y"
                                {
				(yyval.number) = (yyvsp[0].number);
				}
#line 1469 "y.tab.c"
...
#line 141 "termproject.y"
                        {
			live_variables.insert((yyvsp[0].str));
			}
#line 1477 "y.tab.c"
    break;

  case 15:
#line 146 "termproject.y"
                        {
			live_variables.insert((yyvsp[-2].str));
			}
#line 1485 "y.tab.c"
    break;
